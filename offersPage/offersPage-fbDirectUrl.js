...
const offerModal = document.getElementById("modal-get-offer2");
...
async function getOfferInfo(experienceName) {
  ...
  try {
    ...
    if (data && data.length > 0) {
      ...
      if (offer.offer_type === "[F&B] Direct - Referral URL") {
        // Set Experience Name
        ...
        // Set Suppplier Name
        const supplierElement = document.getElementById("offer-supplier-instore");
        if (supplierElement) {
        ...
        // Set price
        const priceElement = document.getElementById("fb-offer-price-voucher");
        if (priceElement) {
        ...
        const buttonGetOffer = document.getElementById("button-redeem-fb");
